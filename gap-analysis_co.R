...
eco_dir <- "/mnt/workspace_cluster_6/ccsosa/GAP_ANALYSIS_US_2016/gap_analysis/geodata/wwf_eco_terr" # !!! change accordingly !!!
...
# source(paste(src.dir,"/005.modelingApproach.R",sep=""))
 ...
 source(paste(src.dir,"/","000.nullModel.R",sep=""))
...
source(paste(src.dir,"/Ensemble_test_model.R",sep=""))
...
source(paste(src.dir,"/CHOOSE_BEST_MODEL.R",sep=""))
...
source(paste(src.dir,"/clean_maps.R",sep=""))



source(paste(src.dir,"/MAPPING_CWR_SP_NAREA.R",sep=""))
